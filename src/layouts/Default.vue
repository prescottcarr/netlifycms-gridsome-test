          ...
          <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
              <g-link to="/" class="flex-shrink-0">
                <img class="block lg:hidden h-8 w-auto" src="/images/uploads/workflow-mark-on-dark.svg" alt="Workflow logo" />
                <img class="hidden lg:block h-8 w-auto" src="/images/uploads/workflow-logo-on-dark.svg" alt="Workflow logo" />
              </g-link>
